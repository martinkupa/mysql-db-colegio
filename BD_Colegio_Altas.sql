...
-- Dasilva Alumno:
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('54781771','Pablo','Bermudez','19-9-2003','Cullen_2023','pablocapo@gmail.com','543G76A','1','3','2',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('54682333','Anasui','Gutierrez','20-10-2004','Av.Truinvirato 2013','Anasuigutierrez2004@gmail.com','5165D6A','0','4','1',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('48291924','Astor','Cujoh','31-5-2005','Av Maipú 492','astoretegamer@gmail.com','55345AD','0','2','1',2);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('51235361','Ezequiel','Trefiletti','10-3-2001','Av Belgrano Sur 3185','Ezequielelmejor@gmail.com','5df23A','1','6','1',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('55123123','Jose','Jovin','19-7-2006','Arenales 3648','jojovinpro2006@hotmail.com.ar','649F9D1','0','1','2',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('54123649','Jorge','Silva','01-08-2004','Florida 700','jorgecolegio@gmail.com','523F2DA','0','3','4',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('52354245','Lozano','Valencia','9-12-2002','Av Colón 628','Loza2002@gmail.com','51235fd','1','5','2',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('54231234','Javier','Garcia','05-01-2003','Av Rivadavia 1291','javielmejor@gmail.com','54f31ad','1','4','2',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('53412356','Dante','Sparta','11-3-2004','Av Gaona 2525','dantewahoo@gmail.com','9df2af','0','3','4',1);
INSERT INTO alumno(PK_dni,nombre,apellido,fechaNacimiento,direccion,email,tarjetaId,mayoriaEdad,FK_año,FK_division,FK_rotacion) VALUES ('53474561','Lautaro','Aleta','09-06-2002','Av Corrientes 655','lautarobasado@gmail.com','3254fd1','1','6','2',2);
